...
describe("[Mutation.bookTrips]", () => {
  const { bookTrips } = mockContext.dataSources.UserDataSource;
...
describe("[Mutation.cancelTrip]", () => {
  const { cancelTrip } = mockContext.dataSources.UserDataSource;
  const { getLaunchById } = mockContext.dataSources.LaunchDataSource;
...
describe("[Mutation.login]", () => {
  const { findOrCreateUser } = mockContext.dataSources.UserDataSource;
