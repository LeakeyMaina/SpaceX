...
const ds = new UserDataSource({ store: mockStore });
ds.initialize({ context: { user: { id: 1, email: "a@a.a" } } });

describe("[UserDataSource.findOrCreateUser]", () => {
...
describe("[UserDataSource.bookTrip]", () => {
...
describe("[UserDataSource.bookTrips]", () => {
...
describe("[UserDataSource.cancelTrip]", () => {
...
describe("[UserDataSource.getLaunchIdsByUser]", () => {
