...
const ds = new LaunchDataSource();
ds.get = mocks.get;

describe("[LaunchDataSource.launchReducer]", () => {
  it("properly transforms launch", () => {
    expect(ds.launchReducer(mockLaunchResponse)).toEqual(mockLaunch);
  });
});

describe("[LaunchDataSource.getAllLaunches]", () => {
...
describe("[LaunchDataSource.getLaunchById]", () => {
...
describe("[LaunchDataSource.getLaunchesByIds]", () => {
